...
about: Want us to add any features to canalytics?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with canalytics. Please take the time to
...
<!--
  Why do you want to see this feature in canalytics? What use cases does it support?
-->
